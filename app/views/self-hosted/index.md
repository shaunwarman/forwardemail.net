...
* **Backup**: Will take a backup of mongoDB and sqlite and expose common paths [mentioned below](#import-folders-and-files) on the host. It is up to you to transfer this remotely.
...
* **Upgrade**: Upgrade to the latest forward email code base, rebuild and restart infrastructure components.
* **Restore from backup**: Will trigger mongodb to restore from backup data. It's important to place the backup files in the [specified folders below](#import-folders-and-files).

##### Initial Setup (Option 1)

Choose option `1. Initial setup` to begin. This option will:

This step takes about **5 minutes** to build the application and spin up each component.
